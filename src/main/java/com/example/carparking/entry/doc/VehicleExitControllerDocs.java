...
public interface VehicleExitControllerDocs {

    @Operation(summary = "Request a Vehicle Exit")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Vehicle exit process initiated successfully",
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            name = "Response Initialized Vehicle Exit",
                                            value = """
                                                            {
                                                              "id": 1,
                                            ...
                                            value = """
                                                            {
                                                               ...
                                                               "instance": "/api/v1/parking/entry/exit",
                                                               "status": 400,
    ...
    ResponseEntity<ParkingEntryResponse> vehicleExit(ParkingExitRequest request);
}
